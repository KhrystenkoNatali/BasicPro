...
public class Main2 {
    public static void main(String[] args) {
        ...
        List<String> fioList = PersonsService.getInfo3(list, p -> p.getfName() + " " + p.getlName());
        PersonsService.print(fioList);

        System.out.println();
        System.out.println("Список email: ");
        List<String> emailList = PersonsService.getInfo3(list, p -> p.getEmail());
        PersonsService.print(emailList);

        System.out.println();
        System.out.println("Список телефонов: ");
        List<String> phoneList = PersonsService.getInfo3(list, p -> p.getPhone());
        PersonsService.print(phoneList);

        System.out.println();
        System.out.println("Список адресов в виде строк");
        List<String> strAddressLst = PersonsService.getInfo3(list, p -> p.getAddress().toString());
        PersonsService.print(strAddressLst);

        System.out.println();
        System.out.println("Лист из адресов в виде объектов ");
        List<Address> listAddresses = PersonsService.getInfo3(list, p -> p.getAddress());
        PersonsService.print(listAddresses);


        System.out.println("----------------------------------");
        System.out.println();
        System.out.println("Лист из адресов в виде объектов (обобщенный): ");
        List<Address> listAddress2 = PersonsService.getInfo3(list, p -> p.getAddress());
        PersonsService.print(listAddress2);
        System.out.println("Лист городов: ");
        List<String> cityList = PersonsService.getInfo2(listAddress2, a -> a.getCity());
        PersonsService.print(cityList);

        System.out.println();
        System.out.println("===========================");
        List<Integer> info2 = PersonsService.getInfo3(List.of("qwe", "ywtwt", "y"), s -> s.length());
